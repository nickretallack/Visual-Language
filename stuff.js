...
(function() {
  var connecting_object, dragging_object, dragging_offset, is_valid_json, module, pretty_json, string_contains, valid_json;
  ...
  module.controller('library', function($scope, $q, interpreter, $filter) {
    ...
    return $scope.search_filter = function(item) {
      ...
      search_field = function(field) {
        return string_contains(item[field], query);
      };
