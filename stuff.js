...
(function() {
  ...
  module.directive('subroutine', function() {
    return function(scope, element, attributes) {
      var graphics;
      graphics = Raphael.apply(null, [element[0]].concat(__slice.call(editor_size.components())));
      return scope.$watch(attributes.subroutine, function(subroutine) {
        ...
        for (id in _ref) {
          node = _ref[id];
          _results.push(new NodeView(graphics, node));
        }
        return _results;
      });
    };
  ...
  NodeView = (function() {
    ...
    function NodeView(graphics, node) {
      ...
      this.set.push(graphics.rect(corner_position.x - 5, corner_position.y, text_width + 10, size.y));
    }
