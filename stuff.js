...
var NodeView, animate, animations_counter, blab, connecting_object, connection_view, dissociate_exception, dragging_object, dragging_offset, editor_size, eval_expression, execute, get_absolute_nib_position, get_nib_position, highlight, highlighted_objects, ignore_if_disconnected, last, make_arrow, make_box, make_connection, make_nib_view, make_node_view, make_subroutine_view, make_text, module, mouse_coords, obj_first, pretty_json, ray_cast_mouse, transform_position, unhighlight, unhighlight_all, update, valid_json, whitespace_split;
...
module.directive('connections', function() {
  return {
    link: function(scope, element, attributes) {
      var draw, resize_canvas, subroutine;
      subroutine = null;
      draw = function() {
        var c, connection, id, line_height, node_position, position, _ref, _results;
        if (subroutine) {
          line_height = 16;
          ...
          for (id in _ref) {
            ...
            if (node_position) {
              ...
              _results.push(c.fillRect(position.x, position.y, 10, 10));
            } else {
