...
load_implementation = function(subroutine, data) {
  var builtin, connection, node, position, sink, sink_connector, source, source_connector, value, _i, _j, _len, _len2, _ref, _ref2, _results;
  _ref = data.nodes;
  for (_i = 0, _len = _ref.length; _i < _len; _i++) {
    node = _ref[_i];
